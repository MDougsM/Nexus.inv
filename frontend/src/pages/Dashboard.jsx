    ...
    <div className="max-w-[1400px] mx-auto space-y-8 animate-fade-in pb-10">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm font-bold uppercase tracking-widest mt-1 opacity-50" style={{ color: 'var(--text-muted)' }}>Telemetria em Tempo Real</p>
        </div>
        <button onClick={() => navigate('/cadastro')} className="hidden sm:flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl font-black hover:bg-blue-700 hover:-translate-y-1 transition-all shadow-lg shadow-blue-500/30 active:scale-95">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        {/* FEED AO VIVO CORRIGIDO PARA O TEMA BLACK */}
